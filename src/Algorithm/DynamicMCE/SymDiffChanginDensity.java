...
public class SymDiffChanginDensity {
	...
	// IOException{
	public SymDiffChanginDensity(Set<int[]> batch) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			FileWriter gw = new FileWriter(graph + "_" + count, true);
			...
			int num_edges = G.numE();
			int num_vertices = G.numV();
			
			double initial_density = (double)2.0*num_edges/((double)num_vertices*(num_vertices-1));
			
			System.out.println(initial_density);
			
			G.print(gw);
			
			gw.close();
/*			
			int added_edges_initially = edge_count;
			...
			subSize = 0;
			new SymDiffChanginDensity(batch);
			...
			out.println(count + "," + batch_size + "," + ncliqueCount + "," + subCliqueCount + "," + total_number + "," + ncliqueSizes + "," + subSize + "," + total_size + "," + newCliqueSizeInNodes + "," + subCliqueSizeInNodes + ","
					+ total_size_in_nodes + "," + new_time + "," + sub_time + "," + recompute_time + "," + other_time + "," + cumulative_time  + "," + sc + "," + added_edges_initially + "," + initial_density);
			out.close();
			*/
