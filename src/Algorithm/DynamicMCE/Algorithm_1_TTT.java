...
public class Algorithm_1_TTT {
	...
	public Algorithm_1_TTT(Set<int[]> batch) throws IOException {
		...
		for (int[] e : batch) {
			...
			TTT ttt = new TTT(IndG);

			Collection<TreeSet<Integer>> maxcliques = ttt.collect();
